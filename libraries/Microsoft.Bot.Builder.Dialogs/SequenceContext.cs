...
namespace Microsoft.Bot.Builder.Dialogs
{
    ...
    {
        private readonly SequenceDialog _parent;
        private bool _nextCalled;

        internal SequenceContext(SequenceDialog parent, DialogContext dc, object options, IDictionary<string, object> values, int index, DialogReason reason, object result = null)
